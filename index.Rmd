---
title: "EasyPeasy (pt-br)"
author: "Equipe de tradução do EasyPeasy"
date: "`r Sys.Date()`"
site: bookdown::bookdown_site
description: "O método EasyPeasy para abandonar a pornografia."
documentclass: book
classoption: openany
lang: es
url: "https://warleytavaresp.github.io/easypeasymethodbrasil"
cover-image: "img-cover.jpg"
pdf-cover-image: "img-cover.jpg"
mainfont: Arial
header-includes:
  - \usepackage{setspace}
  - \onehalfspacing
  ...
  - \pretitle{\begin{center}
    \includegraphics[width=7in,height=7in]{img-cover.jpg}\LARGE\\}
...
![Imagen de portada](img-cover.jpg){width=45% height=45%}\
...
Lembrete rápido: <span style="font-size:larger;">**NÃO PULE CAPÍTULOS**</span>
